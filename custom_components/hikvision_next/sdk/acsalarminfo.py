...
ACS_FACE_VERIFY_PASS_MINORS: frozenset[int] = frozenset(
    event.value
    for event in (
        AcsAlarmInfoMajorEvent.MINOR_FACE_AND_FP_VERIFY_PASS,
        AcsAlarmInfoMajorEvent.MINOR_FACE_AND_PW_VERIFY_PASS,
        AcsAlarmInfoMajorEvent.MINOR_FACE_AND_CARD_VERIFY_PASS,
        AcsAlarmInfoMajorEvent.MINOR_FACE_AND_PW_AND_FP_VERIFY_PASS,
        AcsAlarmInfoMajorEvent.MINOR_FACE_CARD_AND_FP_VERIFY_PASS,
        AcsAlarmInfoMajorEvent.MINOR_FACE_VERIFY_PASS,
        AcsAlarmInfoMajorEvent.MINOR_EMPLOYEENO_AND_FACE_VERIFY_PASS,
    )
)
